...
local function modify_lab_layers(layers)
    ...
    for i, layer in ipairs(layers) do
        layer.filename = base_layers.normal[i][1]:gsub("__base__", "__infused-science__")
        layer.hr_version.filename = base_layers.hr[i][1]:gsub("__base__", "__infused-science__")
...
local function modify_lab_remnant_layers(layers)
    for _, layer in ipairs(layers) do
        layer.filename = base_remnant_layers.normal[1]:gsub("__base__", "__infused-science__")
        layer.hr_version.filename = base_remnant_layers.hr[1]:gsub("__base__", "__infused-science__")
...
infusionLab.icon = "__infused-science__/graphics/icons/lab.png"
...
infusionLabRemnants.icon = "__infused-science__/graphics/icons/lab.png"
